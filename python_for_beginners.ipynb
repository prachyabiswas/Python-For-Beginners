  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        "# if elif else\n",
        "\n",
        "hero = input(\"Enter your favorite superhero: \")\n",
        "if hero == \"Batman\":\n",
        "    print(\"Welcome, Dark Knight!\")   #In a print() statement, the comma separates multiple values.\n",
        "elif hero == \"Superman\":             #**The colon `:` in Python tells the program to begin an indented block of code under a condition or definition.\n",
        "    print(\"Hello, Man of Steel!\")\n",
        "elif hero == \"Spiderman\":            #elif: lets you check another condition if the previous `if` was false\n",
        "    print(\"Hey Spidey, nice to swing by!\")\n",
        "else:\n",
        "    print(\"You're awesome too, hero from another universe!\")    #The else block runs if none of the above conditions are true.\n",
        "\n",
        "print(\"This is the end of the superhero greeting!\")\n"
      ]
    }
  ],
  "metadata": {
